...
According to our data, the log odds of having a sleep disorder for a person who is overweight is 1.03 times the odds of a person of normal weight. The odds ratio of a person who is overweight are 2.800000e+00 times those of a person of normal weight. So, a person who is overweight is 1.8% more likely to have a sleep disorder relative to a person of normal weight. 

Moreover, the log odds of having a sleep disorder for a person who is obese is 31.30 times the odds of a person of normal weight. The odds ratio of a person who is obese is3.902103e+13 times those of a person of normal weight. Therefore, individuals who are obese have a significantly higher likelihood of experiencing a sleep disorder, with a staggering percentage change of -1.8% compared to individuals of normal weight.
...
Our findings indicate that, compared to doctors, engineers have a log odds of having a sleep disorder that is 1.55 times the odds of individuals in other occupations. The odds ratio for engineers is 4.720000e+00, implying that they have 4.720000e+00 times the odds of developing a sleep disorder compared to doctors. This represents a percentage change of -3.72%, meaning that engineers are 5.71% more likely to have a sleep disorder than individuals in other professions.
...
Based on our data, for each unit increase in sleep duration, the log odds of having a sleep disorder decrease by a factor of -0.70. The odds ratio for sleep duration is 5.000000e-01. This corresponds to a percentage change of 0.53%, suggesting that longer sleep duration is associated with a 0.53% reduction in the likelihood of experiencing a sleep disorder.

-   **Blood Pressure --- Elevated**

Our findings indicate that the log odds of having a sleep disorder for individuals with elevated blood pressure are 3.17 times the log odds of individuals with normal blood pressure. The odds ratio for elevated blood pressure is 3.17. This corresponds to a percentage change of -9.03%, indicating that elevated blood pressure increases the likelihood of having a sleep disorder by 9.03%.

-   **Blood Pressure --- Hypertension**

According to our data, individuals with hypertension have a log odds of having a sleep disorder that is 4.77 times the log odds of individuals with normal blood pressure. The odds ratio for hypertension is 1.179000e+02. This corresponds to a substantial percentage change of -116.9%, suggesting that an individual with hypertension is highly likely to have a sleep disorder.
